                    ...
                    <div class="col-lg-9">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide mb-4"
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img src="img/slider/HoaLo6.png" class="d-block w-100" alt="...">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5>300.000</h5>
                                    <p class="card-text">         Hải Dương là một tỉnh nằm ở miền Bắc Việt Nam, thuộc vùng đồng bằng sông Hồng, cách thủ đô Hà Nội khoảng 60km về phía Đông Nam. Hải Dương không chỉ nổi bật với vị trí địa lý thuận lợi mà còn là nơi lưu giữ nhiều giá trị văn hóa, lịch sử và các danh lam thắng cảnh đặc sắc.
                                    </p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">&#9733; &#9733; &#9733;
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                <a href="#"><img class="card-img-top" src="img/product/Thanh_Hóa.png"
                                                 alt="" ></a>
                                <div class="card-body">
                                    <h4 class="card-title">
                                        <a href="<%=url%>/thongTinTourDuLich.jsp?id=36">Thanh Hóa</a>
                                    </h4>
                                    <h5>1.000.000</h5>
