				...
				<div class="row">
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top" src="img/product/LTT3.png"
								alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
								...
								<p class="card-text">
                                                                    ...
                                                                    VNU University of Science – VNU-HUS   là một trong những trường đại học thành viên của Đại học Quốc gia Hà Nội; là đơn vị trọng điểm, đầu ngành của Việt Nam về đào tạo, nghiên cứu khoa học cơ bản và khoa học công nghệ, mang tính ứng dụng cao 
                                                                </p>
							</div>
