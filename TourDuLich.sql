...
-- Dumping data for table mywebsite.danhgia: ~24 rows (approximately)
DELETE FROM `danhgia`;
INSERT INTO `danhgia` (`ID`, `makhachhang`, `ID_diadiem`, `diem`, `binhluan`, `ngaydanhgia`) VALUES
	...
	(21, '1667732670893', '19LTT', 5, 'Địa điểm này rất tuyệt vời, tôi đã có một chuyến đi tuyệt vời tại đây!', '2024-11-30 11:32:22'),
	(22, '1667732836737', '334', 4, 'Trường học này rất đẹp, nhưng dịch vụ có thể cải thiện thêm một chút.', '2024-11-30 11:32:22'),
	(23, '1667732670893', '19LTT', 5, 'Địa điểm này rất tuyệt vời, tôi đã có một chuyến đi tuyệt vời tại đây!', '2024-11-30 12:08:58'),
	(24, '1667732836737', '334', 4, 'Trường học này rất đẹp, nhưng dịch vụ có thể cải thiện thêm một chút.', '2024-11-30 12:08:58');

-- Dumping structure for table mywebsite.danhsachtour
CREATE TABLE IF NOT EXISTS `danhsachtour` (
  `nametour` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tourID` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '44',
  `ngaykhoihanh` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thoigian` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lichtrinh` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `giatour` int DEFAULT NULL,
  PRIMARY KEY (`tourID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table mywebsite.danhsachtour: ~1 rows (approximately)
DELETE FROM `danhsachtour`;
INSERT INTO `danhsachtour` (`nametour`, `tourID`, `ngaykhoihanh`, `thoigian`, `lichtrinh`, `giatour`) VALUES
	('Phú Thọ', '19', '7 tháng 4 năm 2025', '24.0', 'Tour du ngoạn Phú Thọ', 400000);
...
CREATE TABLE IF NOT EXISTS `khachhang` (
  ...
  `diachi` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
